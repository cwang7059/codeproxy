...
import {
  ...
  GPT_IMAGE_MODEL,
  IMAGE_EDITS_ENABLED,
  IMAGE_GENERATION_PHASE_STATUS_INDEX,
  IMAGE_GENERATION_TASK_POLL_INTERVAL_MS,
  MAX_UPLOAD_IMAGES,
  QUALITY_OPTIONS,
  SIZE_OPTIONS,
} from "@/modules/image-generation/image-generation-constants";
import type { GeneratedImage, ImageMode, UploadedImage } from "@/modules/image-generation/image-generation-types";
import {
  createUploadPreviewUrl,
  extractImageGenerationTaskError,
  formatGenerationElapsed,
  revokeUploadPreviewUrl,
  wait,
} from "@/modules/image-generation/image-generation-utils";
import { EmptyState } from "@/modules/ui/EmptyState";
import { Button } from "@/modules/ui/Button";
import { ImagePreviewOverlay } from "@/modules/ui/ImagePreviewOverlay";
import { Modal } from "@/modules/ui/Modal";
import { Select } from "@/modules/ui/Select";
export function ImageGenerationTestModal({ open, onClose }: { open: boolean; onClose: () => void }) {
