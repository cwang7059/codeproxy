...
import type { ModelPricingMode } from "@/modules/models/modelAvailability";
import {
  formatPrice,
  normalizeOwnerValue,
  type ModelFormState,
...
export type ModelConfigModalProps = {
  ...
  onModelIdSuggestionsOpenChange: (open: boolean) => void;
...
export function ModelConfigModal({
  ...
  onSave,
  onUpdateForm,
  onModelIdSuggestionsOpenChange,
              ...
              <div className="relative">
                <TextInput
                  ...
                  onChange={(e) => {
                    ...
                    onModelIdSuggestionsOpenChange(Boolean(nextId.trim()));
                  }}
                  onFocus={() => onModelIdSuggestionsOpenChange(Boolean(form.id.trim()))}
                  onBlur={() => {
                    window.setTimeout(() => onModelIdSuggestionsOpenChange(false), 120);
                  }}
                  placeholder={
                    !form.originalId && activeTab === "library"
          ...
          {form.mode === "call" ? (
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => onUpdateForm({ pricePerCall: e.target.value })}
                placeholder="0.04"
                step="0.01"
                min={0}
              />
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <div>
                ...
                <TextInput
                  ...
                  onChange={(e) => onUpdateForm({ inputPrice: e.target.value })}
              ...
              <div>
                ...
                <TextInput
                  ...
                  onChange={(e) => onUpdateForm({ outputPrice: e.target.value })}
              ...
              <div>
                ...
                <TextInput
                  ...
                  onChange={(e) => onUpdateForm({ cachedPrice: e.target.value })}
